...
const Contactform = () => {
    ...
    const onSubmit = async(event)=>{
        ...
        try {
            ...
            formdata.append("access_key","60c13c9e-5c80-4890-a72d-3773d49964d1")
                    ...
                    <div className="grid lg:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-4xl max-lg:max-w-2xl bg-white [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
                        <div>
                            ...
                            <p className="text-[15px] text-slate-600 mt-4 leading-relaxed">
                                 Got something on your mind? Whether it’s feedback, a query, or a collaboration opportunity — feel free to drop us a message. We’re here to help!
                            </p>
                            <div className="mt-12">
                                ...
                                <ul className="mt-4">
                                    <li className="flex items-center">
                                        ...
                                        <a href="javascript:void(0)" className="text-sm ml-4">
                                            <small className="block text-slate-900">Gmail</small>
